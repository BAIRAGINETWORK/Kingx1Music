...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("THE_J0KES")
                await self.one.join_chat("ALL_CHANNEL0")
                await self.one.join_chat("THE_GIVEAWAY_CHANNEL")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("THE_J0KES")
                await self.two.join_chat("ALL_CHANNEL0")
                await self.two.join_chat("THE_GIVEAWAY_CHANNEL")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("THE_J0KES")
                await self.three.join_chat("ALL_CHANNEL0")
                await self.three.join_chat("THE_GIVEAWAY_CHANNEL")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("THE_J0KES")
                await self.four.join_chat("ALL_CHANNEL0")
                await self.four.join_chat("THE_GIVEAWAY_CHANNEL")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("THE_J0KES")
                await self.five.join_chat("ALL_CHANNEL0")
                await self.five.join_chat("THE_GIVEAWAY_CHANNEL")
